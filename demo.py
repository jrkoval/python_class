...
#first arg is string '1,2' second arg 2
...
parser.add_argument('-f', '-fields', type=str, dest='fields', required='all')
...
fname = args.fname
if fname:
    print("The filename is provided")
    fobj = open(fname, "r")
else:
    print("filename not provied")
